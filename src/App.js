    ...
    function () {
      ...
      async function fetchMovies() {
        try {
          ...
          if (!res.ok) throw new Error("Something went wrong with movies list");
    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <MoviesList movies={movies} onSelectedMovie={handleSelecteMovie} />
          )}
  ...
  useEffect(
    function () {
      ...
      return function () {
        ...
        console.log(`Cleanup effect funtion for ${title}`);
      };
    },
